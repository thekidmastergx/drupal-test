        ...
        <tbody>
          <tr>
            <td width="25%" rowspan="2" valign="top">
              <a href="http://tamusfa.tamu.edu" target="_blank">
                <img src="https://ci4.googleusercontent.com/proxy/rWjYJbL0w8lPBYMM5GJWzusXcSLZX_telCIftkUYTbglV6Bn_fqtdCMEH2F3vYUrhqpVRqEsZAT46RMkClm-gdJYcp2IoZ8r6YkyYzmqGw=s0-d-e1-ft#http://listserv.tamu.edu/cgi-bin/wa?VL&amp;Y=ec3856f&amp;imgnum=1" alt="Logo" border="0"
                class="CToWUd">
              </a>
            </td>
            <td>
              <span style="font-family:georgia,arial,helvetica,sans-serif;font-size:28px;color:#ffffff;font-weight:bold">SFA Weekly Announcements</span>
            </td>
            <td align="right">
          ...
          <tr>
            <td colspan="2">
              <hr>
              <span style="font-family:georgia,arial,helvetica,sans-serif;font-size:13px;color:#ffffff;font-weight:bold">The only 100% science fiction organization on campus!</span>
            </td>
          </tr>
        </tbody>
      </table>
